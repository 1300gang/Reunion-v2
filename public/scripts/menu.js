...
,
  ...
  },
  {
    ...
    creators: ["les élèves de 4e Galilée du collège Bassin Bleu", "Adrienne", "Jason", "Gérard"],
    scenarioFile: "spirale_salkiraV2.json"
  },
  {
    name: "haRceLemeNt",
    ...
    {
    name: "poRnOgraPhiE",
    image: "/img/prevent_porno/img_contextuel/Pablos-Carlos_Mariley_sur_lit.png",
    stickers: [
      "img/Stykers/Stickers pornographie.png",
      "img/Stykers/Stickers sexualité texte.png",
    ],
    description:
      "Scénario sur la pression affective, le consentement et l'impact de la pornographie dans les relations amoureuses.",
    colors: ["#da15ea", "#f789f2"],
    creators: ["les élèves de 4e Galilée du collège Bassin Bleu", "Adrienne", "Jason", "Gérard"],
    scenarioFile: "scenario_Porno.json"
  },
